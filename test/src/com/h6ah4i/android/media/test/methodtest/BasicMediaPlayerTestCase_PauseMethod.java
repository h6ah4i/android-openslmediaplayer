...
public class BasicMediaPlayerTestCase_PauseMethod
    ...
    public static TestSuite buildTestSuite(Class<? extends IMediaPlayerFactory> factoryClazz) {
        return BasicMediaPlayerTestCaseBase.buildBasicTestSuite(
                BasicMediaPlayerTestCase_PauseMethod.class, factoryClazz);
    }

    public BasicMediaPlayerTestCase_PauseMethod(ParameterizedTestArgs args) {
        super(args);
    }
