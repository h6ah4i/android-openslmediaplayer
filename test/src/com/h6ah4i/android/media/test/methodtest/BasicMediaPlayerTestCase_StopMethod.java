...
public class BasicMediaPlayerTestCase_StopMethod
    ...
    public static TestSuite buildTestSuite(Class<? extends IMediaPlayerFactory> factoryClazz) {
        return BasicMediaPlayerTestCaseBase.buildBasicTestSuite(
                BasicMediaPlayerTestCase_StopMethod.class, factoryClazz);
    }

    public BasicMediaPlayerTestCase_StopMethod(ParameterizedTestArgs args) {
        super(args);
    }
