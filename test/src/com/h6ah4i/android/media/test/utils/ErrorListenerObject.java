...
public class ErrorListenerObject
        extends BasicMediaPlayerEventListenerObject
        implements IBasicMediaPlayer.OnErrorListener {

    public ErrorListenerObject(boolean handled) {
        super();
        mHandled = handled;
    }

    public ErrorListenerObject(Object syncObj, boolean handled) {
        super(syncObj);
        mHandled = handled;
    }
