...
import com.h6ah4i.android.media.test.classtest.BasicMediaPlayerClassTestCase;
import com.h6ah4i.android.media.test.classtest.BassBoostTestCase;
import com.h6ah4i.android.media.test.classtest.EnvironmentalReverbTestCase;
import com.h6ah4i.android.media.test.classtest.EqualizerTestCase;
import com.h6ah4i.android.media.test.classtest.HQEqualizerTestCase;
import com.h6ah4i.android.media.test.classtest.HQVisualizerTestCase;
import com.h6ah4i.android.media.test.classtest.LoudnessEnhancerTestCase;
import com.h6ah4i.android.media.test.classtest.PreAmpTestCase;
import com.h6ah4i.android.media.test.classtest.PresetReverbTestCase;
import com.h6ah4i.android.media.test.classtest.VirtualizerTestCase;
import com.h6ah4i.android.media.test.classtest.VisualizerTestCase;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_AttachAuxEffectMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_GetAudioSessionIdMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_GetCurrentPositionMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_GetDurationMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_IsLoopingMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_IsPlayingMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_PauseMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_PrepareAsyncMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_PrepareMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_ReleaseMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_ResetMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_SeekToMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_SetAudioAttributesMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_SetAudioStreamTypeMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_SetAuxEffectSendLevelMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_SetDataSourceFdMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_SetDataSourceFdOffsetLengthMethod;
...
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_SetOnInfoListenerMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_SetOnPreparedListenerMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_SetOnSeekCompleteListenerMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_SetVolumeMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_SetWakeModeMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_StartMethod;
import com.h6ah4i.android.media.test.methodtest.BasicMediaPlayerTestCase_StopMethod;
import com.h6ah4i.android.media.test.utils.BasicMediaPlayerTestCase_CleanupDummyTestCase;

import junit.framework.TestCase;
import junit.framework.TestSuite;

public class HybridMediaPlayerTest extends TestCase {
    public static TestSuite suite() {
        final Class<? extends IMediaPlayerFactory> factory = HybridMediaPlayerFactory.class;
        ...
        //
        // Special tests for HybridMediaPlayer
        //
