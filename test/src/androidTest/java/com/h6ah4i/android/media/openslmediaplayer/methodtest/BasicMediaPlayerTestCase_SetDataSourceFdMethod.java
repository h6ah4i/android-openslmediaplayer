...
public class BasicMediaPlayerTestCase_SetDataSourceFdMethod
    ...
    public static TestSuite buildTestSuite(
        ...
        return BasicMediaPlayerTestCaseBase.buildBasicTestSuite(
                BasicMediaPlayerTestCase_SetDataSourceFdMethod.class, factoryClazz);
    }

    public BasicMediaPlayerTestCase_SetDataSourceFdMethod(ParameterizedTestArgs args) {
        super(args);
    }
    ...
    protected void onSetDataSource(IBasicMediaPlayer player, Object args) throws IOException {
        player.setDataSource(mInputStream.getFD());
    }
}
