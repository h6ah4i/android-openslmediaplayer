...
#ifndef OPENSLMEDIAPLAYERBASSBOOST_HPP_
#define OPENSLMEDIAPLAYERBASSBOOST_HPP_
...
class OpenSLMediaPlayerBassBoost : public virtual android::RefBase {
public:
    struct Settings {
        int16_t strength;
    };

    OpenSLMediaPlayerBassBoost(const android::sp<OpenSLMediaPlayerContext> &context) OSLMP_API_ABI;
    virtual ~OpenSLMediaPlayerBassBoost() OSLMP_API_ABI;
...
#endif // OPENSLMEDIAPLAYERBASSBOOST_HPP_
